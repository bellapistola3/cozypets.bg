...
const AdminLogin: React.FC = () => {
    ...
    const handleLogin = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const userData = await dbHelpers.getUserByAuthId(user.uid);
            ...
            // Store admin session info in localStorage for persistence if legacy code expects it
            localStorage.setItem('adminAuth', 'true');
            localStorage.setItem('adminRole', (userData as any).role);
