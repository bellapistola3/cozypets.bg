...
const About = () => {
  return (
    <section className="px-6 py-12 max-w-3xl mx-auto text-gray-800">
      ...
      <p className="text-lg mb-6">
        Всичко започна с опита на Алиса – като служител в уютен столичен хотел за домашни любимци. Именно там се ражда идеята, че добрата грижа може да бъде пренесена и в домашна среда. Следват участия в още два специализирани хотела за кучета, котки, папагали, гризачи, рибки и други. Натрупаният опит и страстта към животните прерастват в лична практика – предлагана в рамките на домашния уют.
      </p>
      ...
      <p className="text-lg mb-6">
        CozyPets вече е резултат от усилията и мечтата на четирима приятели – Алиса, Мишо, Борислав и Христо. Всеки от нас допринася със своя опит, страст и желание да изградим платформа, която съчетава удобство, грижа и доверие.
      </p>
      ...
      <p className="text-lg mb-6">
        CozyPets не е просто платформа – това е общност. Поканваме ви да бъдете част от нея – като собственик, който търси сигурна грижа за любимеца си, или като гледач, готов да подари време, обич и внимание.
      </p>

      <div className="text-center mt-10">
        <a href="/contact" className="bg-green-500 hover:bg-green-600 text-white font-semibold
