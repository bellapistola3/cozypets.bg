      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Разходки с кучета</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Гледане на домашни любимци</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Нощна грижа</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Такси за домашни любимци</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center">
                ...
                <a href="tel:+359888123456" className="text-gray-400 hover:text-white transition-colors">
                  +359 888 123 456
                </a>
              </div>
              <div className="flex items-center">
